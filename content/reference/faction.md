...
player commands — and its rules (what a faction may hold, found, and do) are to be
documented as each subsystem is settled.
{{< /callout >}}

## What belongs to a faction

- The **systems** it controls in the [cluster]({{< relref "/reference/cluster.md" >}}).
...
republics, houses, and the like.

{{< callout type="info" >}}
The kinds of government, and what they change about how a faction is run, will be
